const DEFAULTS = {
  ...
  // Manager. Plain "English" is en; "English (US)" is en_US. Meta treats them
  // as different templates and rejects a mismatch. Both project templates were
  // created as plain English.
  templateLanguage: 'en',
